...
class UpdatePasswordApp extends ConsumerStatefulWidget {
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _UpdatePasswordAppState();
}

class _UpdatePasswordAppState extends ConsumerState<UpdatePasswordApp> {
                    ...
                    RichText(
                      ...
                      text: TextSpan(
                        children: [
                          TextSpan(
                            text:
                                'This password recovery link is either invalid or has expired. To reset your password, return to the login page and select',
                            style: TypeUtil(
                                    context: context,
                                    height: 1.5,
                                    fontFamily: DsUtils.themeConfiguration(ref)
                          ...
                          const TextSpan(
                              text: 'to send a new recovery email. '),
                        ],
                        style: TypeUtil(
                                context: context,
                                height: 1.5,
