...
import 'package:emp_ai_auth/features/forgot-password/presentation/widgets/update_password_app.dart';
...
class _UpdatePasswordScreenState extends ConsumerState<UpdatePasswordScreen> {
  ...
  Widget build(BuildContext context) {
    // Listen for state change on UpdatePasswordNotifier
    ref.listen(
